...
o01= Operator.create!({ :nombre => "Gerardo Ramirez"})
o01= Operator.create!({ :nombre => "Eleazar Villar"})
o01= Operator.create!({ :nombre => "Sergio Maquez"})
o01= Operator.create!({ :nombre => "Pablo Salinas"})
o01= Operator.create!({ :nombre => "Oscar Ferrer"})
o01= Operator.create!({ :nombre => "Jose C. Hernandez"})
o01= Operator.create!({ :nombre => "Salvador Trejo"})
o01= Operator.create!({ :nombre => "Maximino Guerrero"})
o01= Operator.create!({ :nombre => "Jose M. Nuñez"})
o01= Operator.create!({ :nombre => "Mario Perea"})
o01= Operator.create!({ :nombre => "Francisco Mayen"})
o01= Operator.create!({ :nombre => "Asiganado a Cancun"})
o01= Operator.create!({ :nombre => "Ernesto Jimenez"})
o01= Operator.create!({ :nombre => "Carlos Tellez"})
o01= Operator.create!({ :nombre => "Francisco Jimenez"})
o01= Operator.create!({ :nombre => "Juan P. Martinez"})
o01= Operator.create!({ :nombre => "Asiganado a Cancun"})
o01= Operator.create!({ :nombre => "Alejandro Salgado"})
o01= Operator.create!({ :nombre => "Miaguel A. Sanchez"})
o01= Operator.create!({ :nombre => "Erick Mendoza"})
o01= Operator.create!({ :nombre => "Marco A. Rodriguez"})
o01= Operator.create!({ :nombre => "Antonio Sanchez"})
...
b18= Bus.create!({:numero => "43", :marca => "SCANIA", :capacidad => "47", :modelo => "2013", :placa => "868RN1", :version => "IRIZAR PB", :operator_id =>19 })
b19= Bus.create!({:numero => "44", :marca => "SCANIA", :capacidad => "47", :modelo => "2013", :placa => "869RN1", :version => "IRIZAR PB", :operator_id =>20 })
b20= Bus.create!({:numero => "45", :marca => "SCANIA", :capacidad => "49", :modelo => "2013", :placa => "870RN1", :version => "IRIZAR PB", :operator_id =>21 })
b21= Bus.create!({:numero => "46", :marca => "SCANIA", :capacidad => "53", :modelo => "2016", :placa => "612RR1", :version => "IRIZAR PB", :operator_id =>22 })
