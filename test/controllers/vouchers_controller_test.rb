...
class VouchersControllerTest < ActionController::TestCase
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post :create, voucher: { ano: @voucher.ano, cantidad: @voucher.cantidad, fecha: @voucher.fecha, mes: @voucher.mes, nota: @voucher.nota, operacion: @voucher.operacion, operator_id: @voucher.operator_id }
    end
  ...
  test "should update voucher" do
    patch :update, id: @voucher, voucher: { ano: @voucher.ano, cantidad: @voucher.cantidad, fecha: @voucher.fecha, mes: @voucher.mes, nota: @voucher.nota, operacion: @voucher.operacion, operator_id: @voucher.operator_id }
    assert_redirected_to voucher_path(assigns(:voucher))
  end
